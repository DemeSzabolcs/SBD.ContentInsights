 ...
 */
const U = globalThis, L = U.ShadowRoot && (U.ShadyCSS === void 0 || U.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, j = Symbol(), q = /* @__PURE__ */ new WeakMap();
let tt = class {
  constructor(t, e, s) {
...
const nt = (r) => new tt(typeof r == "string" ? r : r + "", void 0, j), ht = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: lt, defineProperty: ct, getOwnPropertyDescriptor: dt, getOwnPropertyNames: pt, getOwnPropertySymbols: ut, getPrototypeOf: $t } = Object, N = globalThis, W = N.trustedTypes, ft = W ? W.emptyScript : "", _t = N.reactiveElementPolyfillSupport, E = (r, t) => r, H = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? ft : null;
      break;
  ...
  return e;
} }, z = (r, t) => !lt(r, t), Z = { attribute: !0, type: String, converter: H, reflect: !1, useDefault: !1, hasChanged: z };
...
let A = class extends HTMLElement {
  ...
  requestUpdate(t, e, s) {
    if (t !== void 0) {
      ...
      if (s ??= i.getPropertyOptions(t), !((s.hasChanged ?? z)(o, e) || s.useDefault && s.reflect && o === this._$Ej?.get(t) && !this.hasAttribute(i._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
A.elementStyles = [], A.shadowRootOptions = { mode: "open" }, A[E("elementProperties")] = /* @__PURE__ */ new Map(), A[E("finalized")] = /* @__PURE__ */ new Map(), _t?.({ ReactiveElement: A }), (N.reactiveElementVersions ??= []).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const D = globalThis, T = D.trustedTypes, J = T ? T.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, et = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, st = "?" + f, gt = `<${st}>`, m = document, S = () => m.createComment(""), C = (r) => r === null || typeof r != "object" && typeof r != "function", I = Array.isArray, mt = (r) => I(r) || typeof r?.[Symbol.iterator] == "function", k = `[ 	
\f\r]`, b = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, K = /-->/g, Y = />/g, _ = RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), G = /'/g, Q = /"/g, it = /^(?:script|style|textarea|title)$/i, At = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), vt = At(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), X = /* @__PURE__ */ new WeakMap(), g = m.createTreeWalker(m, 129);
function rt(r, t) {
...
const yt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, u = 0;
    for (; u < h.length && (n.lastIndex = u, p = n.exec(h), p !== null); ) u = n.lastIndex, n === b ? p[1] === "!--" ? n = K : p[1] !== void 0 ? n = Y : p[2] !== void 0 ? (it.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = _) : p[3] !== void 0 && (n = _) : n === _ ? p[0] === ">" ? (n = i ?? b, l = -1) : p[1] === void 0 ? l = -2 : (l = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? _ : p[3] === '"' ? Q : G) : n === Q || n === G ? n = _ : n === K || n === Y ? n = b : (n = _, i = void 0);
    const $ = n === _ && r[a + 1].startsWith("/>") ? " " : "";
    o += n === b ? h + gt : l >= 0 ? (s.push(c), h.slice(0, l) + et + h.slice(l) + f + $) : h + f + (l === -2 ? a : $);
  }
    ...
    for (; (i = g.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(et)) {
          ...
          h.push({ type: 1, index: o, name: O[2], strings: $, ctor: O[1] === "." ? Et : O[1] === "?" ? wt : O[1] === "@" ? St : R }), i.removeAttribute(l);
...
class M {
  ...
  _$AI(t, e = this) {
    t = y(this, t, e), C(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== v && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : mt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class R {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let n = !1;
    if (o === void 0) t = y(this, t, e, 0), n = !C(t) || t !== this._$AH && t !== v, n && (this._$AH = t);
    else {
      const a = t;
      let h, c;
      for (t = o[0], h = 0; h < o.length - 1; h++) c = y(this, a[s + h], e, h), c === v && (c = this._$AH[h]), n ||= !C(c) || c !== this._$AH[h], c === d ? t = d : t !== d && (t += (c ?? "") + o[h + 1]), this._$AH[h] = c;
    }
    n && !i && this.j(t);
  }
  j(t) {
...
Pt?.(P, M), (D.litHtmlVersions ??= []).push("3.3.1");
const xt = (r, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ut = { attribute: !0, type: String, converter: H, reflect: !1, hasChanged: z }, Ht = (r = Ut, t, e) => {
